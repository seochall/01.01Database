...
def openprofile(): #открытие окна профиля
    ...
    def changeinfo(): #изменение внесенных данных
        ...
        if profilelogin!=str(ui2.prof_lineEdit.text()) and str(ui2.prof_lineEdit.text()) in lg:
            ui2.errorprofile_1.setVisible(True)
            ui2.errorprofile_2.setVisible(False)

        elif profilephone!=str(ui2.prof_lineEdit_3.text()) and str(ui2.prof_lineEdit_3.text()) in ph:
            ui2.errorprofile_1.setVisible(False)
            ...
            myConnection.commit()
            ui2.s_label_1.setText(login)
            ui2.s_label_2.setText(password)
            ui2.s_label_3.setText(phone)
            ui2.s_label_4.setText(post)
    ...
    def exitprofile():  # выход из профиля
    ...
    ui2.exit_pushButton.clicked.connect(exitprofile)
